                  ...
                  Row(
                    ...
                    children: [
                      ...
                      buildElevatedButton('Start now',
                          color: ColorConstants.darkPink, onTap: () {}),
                    ],
                  ),
                  Row(
                      ...
                      children: [
                        Expanded(
                          child: buildRow(
                            ...
                            label: controller.currentBooking.value.fromDate!,
                          ),
                        ),
                        Expanded(
                          child: buildRow(
                            icon: Icons.calendar_today,
                            label: controller.currentBooking.value.toDate!,
                          ),
                        ),
                      ],
                    ),
                      ...
                      children: [
                        Expanded(
                          child: buildRow(
                            ...
                            label: controller.currentBooking.value.fromTime!,
                          ),
                        ),
                        Expanded(
                          child: buildRow(
                            icon: Icons.timer_sharp,
                            label: controller.currentBooking.value.toTime!,
                          ),
                        ),
                      ],
                    ),
